...
**Companion to:** [`README.md`](https://github.com/harushmitha/restaurant_reservation/blob/main/README.md) — this document expands on **code quality** and **documentation clarity**, the two dimensions that govern how the system is built and explained.
